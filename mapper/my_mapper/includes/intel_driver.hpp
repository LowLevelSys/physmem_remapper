...
namespace intel_driver
{
	...
	uint64_t AllocContiguousMemory(HANDLE iqvw64e_device_handle, uint64_t size);
	bool RemovePhysicalMemory(HANDLE iqvw64e_device_handle, PLARGE_INTEGER phys_base, PLARGE_INTEGER size);
	bool FreeContiguousMemory(HANDLE iqvw64e_device_handle, uint64_t base);
