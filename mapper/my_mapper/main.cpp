...
int wmain(const int argc, wchar_t** argv) {
	...
	NTSTATUS exitCode = 0;
	if (!kdmapper::MapDriver(iqvw64e_device_handle, raw_image.data(), 0, 0, free_mem, remove_from_system_page_tables, destroy_header, mode, pass_allocation, pass_size, callbackExample, &exitCode)) {
